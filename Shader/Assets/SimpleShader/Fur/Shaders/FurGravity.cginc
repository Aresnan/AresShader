...
void vert(inout appdata_full v)
{
    //顶点偏移
    //重力偏移方向
    float3 direction = v.normal + _Gravity;
    direction.x += sin(_Time.w) * 0.5;
    direction.y += sin(_Time.z) * 0.3;
    //基础位移，只涉及法线方向和层间距
    v.vertex.xyz += direction * _Length * FUR_RENDER_Q; 
